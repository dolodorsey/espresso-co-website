...
export const metadata: Metadata = {
  title: 'Espresso Co. — Brewed for the Pace of the City',
  description: 'Espresso, atmosphere, and refined energy for mornings, meetings, and moments in between. A Casper Group brand.',
}
